...
{- 
DFS
Dado un taleux y una lista de variables nos 
dice si el tableux tiene un camino
que no contenga ninguna de las negaciones 
de la lista dada.
-}
...
intalar paquete Time-it cabal install
-}